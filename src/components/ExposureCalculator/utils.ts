...
export const bortleScaleData: Record<BortleScale, LightPollutionData> = {
  ...
  2: {
    ...
    skyBrightness: '21.99–21.89',
    nakedEyeLimit: '7.0–7.49',
    opticLimit: '16.5',
  ...
  3: {
    ...
    skyBrightness: '21.89–21.69',
    nakedEyeLimit: '6.5–6.99',
    opticLimit: '16.0',
  ...
  4: {
    ...
    skyBrightness: '21.69–20.49',
    nakedEyeLimit: '6.0–6.49',
    opticLimit: '15.5',
  ...
  5: {
    ...
    skyBrightness: '20.49–19.50',
    nakedEyeLimit: '5.5–5.99',
    opticLimit: '14.5–15.0',
  ...
  6: {
    ...
    skyBrightness: '19.50–18.94',
    nakedEyeLimit: '5.0–5.49',
    opticLimit: '14.0–14.5',
  ...
  7: {
    ...
    skyBrightness: '18.94–18.38',
    nakedEyeLimit: '4.5–4.99',
    opticLimit: '14.0',
