...
const AsteroidsEmbed: React.FC<AsteroidsProps> = ({
  embedOptions = {},
  className = ''
}) => {
  const buildEmbedUrl = (): string => {
    const baseUrl = 'https://eyes.nasa.gov/apps/asteroids/#/home';
  ...
  return (
    ...
    >
      <iframe
        ...
        allow="fullscreen"
        aria-label="NASA Eyes on Asteroids Visualization"
      >
        Unable to render the NASA Eyes on Asteroids visualization
      </iframe>
    </div>
  );
};
