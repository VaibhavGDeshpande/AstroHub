...
const EarthEmbed: React.FC<EarthEmbedProps> = ({
  embedOptions = {},
  className = ''
}) => {
  const buildEmbedUrl = (): string => {
    const baseUrl = 'https://eyes.nasa.gov/apps/earth/#/';
  ...
  return (
    ...
    >
      <iframe
        ...
        allow="fullscreen"
        aria-label="NASA Eyes on Earth Visualization"
      >
        Unable to render the NASA Earth visualization
      </iframe>
    </div>
  );
};
